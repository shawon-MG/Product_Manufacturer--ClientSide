...
const Footer = () => {
    return (
        <div className='mt-16'>
            <footer class="footer footer-center p-10 bg-[#a8a29e] text-primary-content rounded-xl">
                <div>
                    ...
                    <p class="font-bold">
                        Bike Engine Manufacturing Ltd. <br />Providing reliable machine parts since 1992
                    </p>
